        ...
        <div className="w-full max-w-md">
          ...
          >
            ...
            <motion.button
              ...
              disabled={isLoading || isGoogleLoading}
              className="w-full flex items-center justify-center gap-3 px-6 py-3 rounded-lg bg-white border-2 border-blue-500 hover:border-primary transition-all duration-300 font-semibold text-text-primary shadow-sm hover:shadow-md disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isGoogleLoading ? (
                <>
            ...
            <div className="mt-6 text-center">
              <button
                onClick={() => router.push("/")}
                className="text-blue-500 cursor-pointer transition-colors text-sm flex items-center justify-center gap-2 mx-auto"
              >
