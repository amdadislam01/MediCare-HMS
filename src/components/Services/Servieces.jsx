  ...
  return (
    <section className="max-w-7xl mx-auto px-6 py-16">
      ...
      <div className="text-center mb-14">
        <p className="text-blue font-semibold tracking-widest uppercase mb-3">
          Departments
        </p>
        ...
        <p className="max-w-2xl mx-auto text-secondary-light text-sm md:text-base">
        ...
        {services.map((s, i) => (
          ...
          >
            ...
            <div className="p-6">
              ...
              <button className="flex items-center gap-2 font-medium text-sm transition-all hover:gap-3 text-blue hover:underline cursor-pointer hover:font-semibold">
