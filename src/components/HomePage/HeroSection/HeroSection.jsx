...
const HeroSection = () => {
  return (
    <section className="relative overflow-hidden flex items-center justify-center bg-blue-900 text-white min-h-[100svh] py-10">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="w-full sm:w-auto flex items-center justify-center gap-2 px-6 py-3 rounded-lg bg-primary font-semibold"
          >
          ...
          <motion.button
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            className="w-full sm:w-auto flex items-center justify-center gap-2 px-6 py-3 rounded-lg bg-secondary font-semibold"
          >
            <Stethoscope size={20} />
            Find a Doctor
          </motion.button>
        ...
        <motion.div
          ...
          className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 mt-8 sm:mt-10"
        >
          {[
            ...
            >
              <stat.icon
                className="mx-auto mb-2 text-blue-200"
                size={24}
              />
